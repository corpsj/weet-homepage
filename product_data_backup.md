...
This file contains the hardcoded product data that was previously used in the application.
Use this as a reference when migrating data to the database or verifying content.

## Small Unit - Private

### 1. 3X9 집
- **Category**: Small unit / Private / S
- **Image**: `/images/products/small/private/01-3x9-house.jpg`
- **Floor Plan**: `/images/products/floor-plans/small-private-plans.png?crop_w=300%&crop_h=440%&crop_t=-111%&crop_l=0%`
- **Price**: 위트문의
...
- **Description**:
완벽하게 계산된 3m x 9m의 효율적인 공간. 하지만 이 집의 진짜 매력은 발코니문을 여는 순간 시작됩니다.
...
- **Floor Plan**: `/images/products/floor-plans/small-private-plans.png?crop_w=407%&crop_h=448%&crop_t=-115%&crop_l=-137%`
- **Price**: 위트문의
...
- **Specs**:
  ...
  - Interior: 자작나무,벽지,안타민
- **Description**:
우리는 이 공간을 건축물처럼 짓지 않고, 가구처럼 정밀하게 짜 맞췄습니다.
...
### 3. 3X6 집 (Stucco)
- **Category**: Small unit / Private / S
- **Image**: `/images/products/small/private/03-3x6-house-stucco.jpg`
- **Floor Plan**: `/images/products/floor-plans/small-private-plans.png?crop_w=407%&crop_h=448%&crop_t=-115%&crop_l=-137%`
- **Price**: 위트문의
...
### 4. 3X6 집 (Corrugated)
- **Category**: Small unit / Private / S
- **Image**: `/images/products/small/private/04-3x6-house-corrugated.jpg`
- **Floor Plan**: `/images/products/floor-plans/small-private-plans.png?crop_w=407%&crop_h=448%&crop_t=-115%&crop_l=-137%`
- **Price**: 위트문의
- **Size**: 3.2m X 6.2m X 높이 3.2m
- **Specs**:
...
### 5. 3X6 CAMPER
- **Category**: Small unit / Private / S
- **Image**: `/images/products/small/private/05-3x6-camper.jpg`
- **Floor Plan**: `/images/products/floor-plans/small-private-plans.png?crop_w=401%&crop_h=440%&crop_t=-112%&crop_l=-226%`
- **Price**: 위트문의
- **Size**: 3.2m X 6.2m X 높이 3.2m
- **Specs**:
  - Structure: 철골구조 + 목구조
...
- **Description**:
벽을 없애 자연과 하나 되는 개방감을 주되, 생활의 필수 요소인 위생과 조리 시설은 모듈러 공법으로 완벽하게 갖췄습니다.
...
- **Floor Plan**: `/images/products/floor-plans/small-private-plans.png?crop_w=714%&crop_h=448%&crop_t=-115%&crop_l=-592%`
- **Price**: 위트문의
...
- **Floor Plan**: `/images/products/floor-plans/small-private-plans.png?crop_w=564%&crop_h=479%&crop_t=-236%&crop_l=-7%`
- **Price**: 위트문의
...
- **Specs**:
  ...
  - Interior: 자작나무
- **Description**:
3면을 채운 책들의 지혜와, 1면을 채운 자연의 영감. 오직 당신만을 위한 '지적 요새'입니다.
...
### 8. 3X3 리트릿
- **Category**: Small unit / Private / S
- **Image**: `/images/products/small/private/08-3x3-retreat.jpg`
- **Floor Plan**: `/images/products/floor-plans/small-private-plans.png?crop_w=657%&crop_h=479%&crop_t=-236%&crop_l=-137%`
- **Price**: 위트문의
- **Size**: 3.2m X 3.2m X 높이 3.2m
- **Specs**:
  - Structure: 철골구조 + 목구조
  ...
  - Interior: 자작나무
- **Description**:
소란스러운 세상을 차단하고, 오직 당신의 호흡과 낮은 햇살만이 머무는 공간.
...
따뜻한 차 한 잔을 우리거나 깊은 호흡을 내쉬는 순간. 이 낮은 공간은 당신의 가장 깊은 무의식의 휴식으로 안내할 것입니다.
...
- **Floor Plan**: `/images/products/floor-plans/small-private-plans.png?crop_w=420%&crop_h=479%&crop_t=-236%&crop_l=-147%`
- **Price**: 위트문의
- **Size**: 3.2m X 6.2m X 높이 3.8m
- **Specs**:
  - Structure: 철골구조 + 목구조
  ...
  - Interior: 자작나무,벽지,안타민
- **Description**:
가족의 행복을 위해, 회사의 목표를 위해 치열하게 살아온 당신. 오직 당신의 룰대로 움직이는 공간이 필요합니다.
...
### 10. 3X6 피터팬의 모험
- **Category**: Small unit / Private / S
- **Image**: `/images/products/small/private/10-3x6-peterpan.jpg`
- **Floor Plan**: `/images/products/floor-plans/small-private-plans.png?crop_w=427%&crop_h=479%&crop_t=-236%&crop_l=-251%`
- **Price**: 위트문의
- **Size**: 3.2m X 6.2m X 높이 3.6m
- **Specs**:
  - Structure: 철골구조 + 목구조
  ...
  - Interior: 자작나무,벽지
- **Description**:
아이들의 가장 위대한 능력은 보이지 않는 것을 보는 힘입니다.
...
### 11. 3X6 버스정류장
- **Category**: Small unit / Public / S
- **Image**: `/images/products/small/public/11-3x6-busstop.jpg`
- **Floor Plan**: `/images/products/floor-plans/small-public-plans.png?crop_w=407%&crop_h=628%&crop_t=-257%&crop_l=0%`
- **Price**: 위트문의
...
- **Specs**:
  ...
  - Interior: -
- **Description**:
시골 버스는 조금 늦게 와도 괜찮습니다. 우리에게는 이야기꽃을 피울 수 있는 넓은 '평상'이 있으니까요.
위트는 시골 어르신들이 버스를 기다리는 시간이 지루하지 않도록, 다리를 펴고 편히 쉬거나 이웃과 담소를 나눌 수 있는 한국의 평상 구조를 도입했습니다.
...
- **Floor Plan**: `/images/products/floor-plans/small-public-plans.png?crop_w=353%&crop_h=454%&crop_t=-185%&crop_l=-115%`
- **Price**: 위트문의
- **Size**: 3.2m X 6.2m X 높이 2.5m
- **Specs**:
  - Structure: 철골구조
...
### 13. 3X9 파고라
- **Category**: Small unit / Public / S
- **Image**: `/images/products/small/public/13-3x9-pergola.jpg`
- **Floor Plan**: `/images/products/floor-plans/small-public-plans.png?crop_w=367%&crop_h=621%&crop_t=-254%&crop_l=-257%`
- **Price**: 위트문의
...
- **Specs**:
  ...
  - Interior: -
- **Description**:
최소한의 기둥, 최대한의 개방감. 철의 강인함으로 나무의 온기를 공중에 띄웠습니다.
