...
const COPY: Record<Language, HomeCopy> = {
  KO: {
    ...
    transparency: {
      ...
      lead: '‘예상치 못한 현장 비용’과 ‘품질 편차’. 주택 설치에서 가장 큰 리스크를 줄이기 위해 위트는 모든 기준을 미리 선명하게 정리합니다.',
      features: [
        {
          title: '모델 및 옵션 구성',
        ...
        {
          title: '운송 및 현장 조립',
          text: '공장 제작 후 현장까지의 운송 일정과 안전한 설치 절차를 미리 안내해, 현장에 머무는 시간을 줄입니다.',
        },
        {
          title: 'A/S 및 사후 관리',
          text: '문·창호 단차, 욕실 누수 등 입주 후 생길 수 있는 주요 AS 항목의 보증 기준과 대응 절차를 안내합니다.',
        },
        {
          title: '공장 제작 기반',
