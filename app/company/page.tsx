...
const CREW_DATA: Record<string, CrewData> = {
  design: {
    name: "박현태",
    role: "DESIGN 부문 대표",
    description: `홍익대학교 건축도시대학 건축학전공 졸업
    
    공간은 단순한 물리적 구조물이 아닙니다.
    그것은 사람들의 삶이 펼쳐지는 무대이자, 감정과 기억이 머무는 그릇입니다.
    
    우리는 사용자의 니즈를 깊이 있게 탐구하고,
    그것을 창의적인 디자인 언어로 재해석하여
    기능성과 심미성이 완벽하게 조화를 이루는 공간을 만듭니다.`,
    sections: [
      {
        title: "건축학력",
        items: ["홍익대학교 건축도시대학 건축학전공 졸업"]
      },
      {
        title: "건축/디자인 경력",
        items: [
          "2021 (주) 디자인 맑음 - 디자인 팀장",
          "2022 (주) 스튜디오 캔 - 디자인 실장",
          "2023 (주) 위트 - 디자인 대표"
        ]
      },
      {
        title: "건축/디자인 공모전 수상",
        items: [
          "2018 제 13회 차세대 문화공간 공모전 - 입선 한국문화공간건축학회",
          "2019 제 2회 마을 만들기 공모전 - 최우수상 (주)대우건설",
