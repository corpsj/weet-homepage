...
export const metadata = buildPageMetadata({
  title: '이용약관',
  description:
    '위트(weet) 이용약관 — 서비스 이용 조건, 회원과 회사의 권리·의무, 책임 범위, 분쟁 해결 기준을 규정합니다.',
  path: '/terms',
});
    ...
    <div className="min-h-screen bg-weet-paper px-[5vw] pb-32 pt-24 md:pt-28">
      <div className="mx-auto max-w-4xl rounded-[16px] border border-weet-line bg-weet-surface p-8 shadow-weet-card md:p-12 lg:p-16">
        ...
        <div className="max-w-none space-y-10 text-weet-sub">
          ...
          <section>
            <h2 className="mb-4 text-[20px] font-semibold tracking-[-0.02em] text-weet-ink md:text-[24px]">제1조 (목적)</h2>
            <p className="text-[16px] leading-[1.85] kr-balance">
              본 약관은 주식회사 위트(이하 "회사")가 운영하는 홈페이지에서 제공하는 이동식주택 정보,
              제품 구성, 주문 요청, 프로젝트·솔루션 콘텐츠, 관리자 운영과 관련한 이용 조건을 정합니다.
            </p>
          </section>

          <section>
            <h2 className="mb-4 text-[20px] font-semibold tracking-[-0.02em] text-weet-ink md:text-[24px]">제2조 (서비스의 내용)</h2>
            <ul className="mt-2 list-disc space-y-2 pl-5 text-[16px] leading-[1.85] kr-balance marker:text-weet-gold-deep">
              ...
              <li>구성 스냅샷을 기반으로 한 주문 요청 접수와 후속 연락</li>
          ...
          <section>
            <h2 className="mb-4 text-[20px] font-semibold tracking-[-0.02em] text-weet-ink md:text-[24px]">제3조 (예상 견적과 상담)</h2>
            <p className="text-[16px] leading-[1.85] kr-balance">
              홈페이지에서 표시되는 예상 총액은 선택한 모델과 옵션을 기준으로 산출한 참고 금액입니다.
              실제 계약 금액과 일정은 현장 진입 조건, 인허가, 기초·전기·상하수도 등 별도 공사, 운반 거리,
              자재와 제작 일정에 따라 달라질 수 있습니다. 주문 요청 시 저장되는 구성 스냅샷은 후속 확인과
              견적 검토를 위한 내부 기록으로 사용됩니다.
            </p>
          </section>

          <section>
            <h2 className="mb-4 text-[20px] font-semibold tracking-[-0.02em] text-weet-ink md:text-[24px]">제4조 (계약과 설치 확정)</h2>
            <p className="text-[16px] leading-[1.85] kr-balance">
              홈페이지 주문 요청만으로 제작, 운반, 설치 계약이 체결되는 것은 아닙니다. 최종 계약은 회사와
          ...
          <section>
            <h2 className="mb-4 text-[20px] font-semibold tracking-[-0.02em] text-weet-ink md:text-[24px]">제5조 (이용자의 의무)</h2>
            <ul className="mt-2 list-disc space-y-2 pl-5 text-[16px] leading-[1.85] kr-balance marker:text-weet-gold-deep">
          ...
          <section>
            <h2 className="mb-4 text-[20px] font-semibold tracking-[-0.02em] text-weet-ink md:text-[24px]">제6조 (콘텐츠와 이용 권리)</h2>
            <p className="text-[16px] leading-[1.85] kr-balance">
          ...
          <section>
            <h2 className="mb-4 text-[20px] font-semibold tracking-[-0.02em] text-weet-ink md:text-[24px]">제7조 (책임의 제한)</h2>
            <p className="text-[16px] leading-[1.85] kr-balance">
