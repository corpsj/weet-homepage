...
export default function SupportClient({ faqs, settings }: { faqs: { question: string; answer: string }[]; settings: SiteSettings }) {
  ...
  return <div className="bg-white text-gray-900">
    ...
    <section id="cost" lang="ko" className="border-y border-gray-200 px-6 py-12 scroll-mt-32"><div className="mx-auto max-w-[1400px]"><h2 className="text-2xl font-bold">제품가와 별도 비용</h2><p className="mt-4 max-w-3xl leading-8 text-gray-600">기본 제품가 외에 유상 옵션, 운반·크레인, 기초와 전기·급배수 공사 비용 등을 확인해야 합니다. 포함 범위와 부가세는 견적서에서 확인하세요.</p><Link href="/guides/mobile-home-cost" className="mt-4 inline-block py-2 font-semibold underline underline-offset-4">비용 항목과 견적 준비 안내 →</Link></div></section>
