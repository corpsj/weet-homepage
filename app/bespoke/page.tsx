...
const COPY: Record<Lang, {
  ...
  EN: {
    headline: 'BESPOKE',
    lead: 'Plan a space around its use, from cafés and showrooms to workshops.',
    highlight: 'Review the purpose, site, equipment and budget together before confirming a design.',
    features: [
      { title: 'Use and circulation', body: 'Start with the required area, circulation and number of users.' },
      { title: '1:1 coordination', body: 'Budget, schedule, and operation scenarios are planned together—every detail is co-created.' },
      { title: 'Site requirements', body: 'Review layout and installation against site conditions and applicable procedures.' },
      { title: 'Finishes and equipment', body: 'Select materials and equipment with budget and maintenance in mind.' },
    ],
    sections: [
      {
        id: 'small-cafe',
        badge: 'COMMERCIAL',
        title: 'SMALL CAFE',
        quote: 'Plan a café around ordering, seating and kitchen circulation.',
        body: 'Review kitchen equipment, electrical capacity, water and drainage alongside the layout and finishes.',
        cta: 'View portfolio',
        image: { src: '/images/bespoke/small-cafe-v2.webp', alt: 'Small Cafe' },
        imageOnRight: true,
      },
      {
        ...
        badge: 'RETAIL & EVENT',
        title: 'POP-UP STORE / BRAND SHOWROOM',
        quote: 'A pop-up or showroom planned for its display and operation.',
        body: 'Plan for the exhibits, visitors and operating period. Installation, removal and transport for reuse require a site-specific review.',
        cta: 'View portfolio',
        image: { src: '/images/bespoke/popup-store-v2.webp', alt: 'Pop-up Store' },
        imageOnRight: false,
      },
      {
        ...
        badge: 'AGRITECH',
        title: 'SMART FARM',
        quote: 'Plan a growing space around the crop and operating method.',
        body: 'Identify temperature, humidity, lighting and water requirements before planning equipment, power and connectivity.',
        cta: 'View portfolio',
        image: { src: '/images/bespoke/smart-farm-v2.webp', alt: 'Smart Farm' },
        imageOnRight: true,
      },
