...
저녁노을을 바라보며 즐기는 시원한 맥주 한 캔.`,
        ...
        floor_plan_url: "/images/products/floor-plans/small-private-plans.png?crop_w=300%&crop_h=440%&crop_t=-111%&crop_l=0%",
        display_order: 1,
        tagline: ""
    },
    {
...
마치 잘 설계된 수납장을 열었을 때 감탄하게 되는 짜임새처럼, 현관부터 거실, 주방, 욕실까지 모든 공간이 유기적으로 연결되어 단 1cm의 낭비도 허용하지 않습니다.`,
        ...
        floor_plan_url: "/images/products/floor-plans/small-private-plans.png?crop_w=407%&crop_h=448%&crop_t=-115%&crop_l=-137%",
        display_order: 2,
        tagline: ""
    },
    {
        ...
        sub_category: "Private",
        size_category: "S",
        image_url: "/images/products/small/private/03-3x6-house-stucco.jpg",
        description: `우리는 이 공간을 건축물처럼 짓지 않고, 가구처럼 정밀하게 짜 맞췄습니다.
마치 잘 설계된 수납장을 열었을 때 감탄하게 되는 짜임새처럼, 현관부터 거실, 주방, 욕실까지 모든 공간이 유기적으로 연결되어 단 1cm의 낭비도 허용하지 않습니다.`,
        price: "위트문의",
        structure: "철골구조 + 목구조",
    ...
    },
    {
        ...
        sub_category: "Private",
        size_category: "S",
        image_url: "/images/products/small/private/04-3x6-house-corrugated.jpg",
        description: `우리는 이 공간을 건축물처럼 짓지 않고, 가구처럼 정밀하게 짜 맞췄습니다.
마치 잘 설계된 수납장을 열었을 때 감탄하게 되는 짜임새처럼, 현관부터 거실, 주방, 욕실까지 모든 공간이 유기적으로 연결되어 단 1cm의 낭비도 허용하지 않습니다.`,
        price: "위트문의",
        structure: "철골구조 + 목구조",
    ...
    },
    {
        ...
        sub_category: "Private",
        size_category: "S",
        image_url: "/images/products/small/private/05-3x6-camper.jpg",
...
훗날 벽을 세워 온전한 집이 될 여지까지 남겨둔, 가능성으로 가득 찬 공간입니다.`,
        ...
        size: "3.2m X 6.2m X 높이 3.2m",
        floor_plan_url: "/images/products/floor-plans/small-private-plans.png?crop_w=401%&crop_h=440%&crop_t=-112%&crop_l=-226%",
        display_order: 5,
        tagline: ""
    },
    {
        ...
        sub_category: "Private",
        size_category: "S",
        image_url: "/images/products/small/private/06-3x3-sauna.jpg",
...
몸은 뜨겁게, 머리는 차갑게. 핀란드의 사우나 문화와 한국의 정자(처마) 감성이 만난 이곳에서, 당신의 몸과 마음은 다시 태어납니다.`,
        ...
        floor_plan_url: "/images/products/floor-plans/small-private-plans.png?crop_w=714%&crop_h=448%&crop_t=-115%&crop_l=-592%",
        display_order: 6,
        tagline: ""
    },
    {
        ...
        sub_category: "Private",
        size_category: "S",
        image_url: "/images/products/small/private/07-3x3-library.jpg",
...
글을 쓰든, 연구를 하든, 혹은 그저 사색에 잠기든. 이곳은 당신의 내면이 가장 또렷해지는 세상에 단 하나뿐인 몰입의 공간입니다.`,
        ...
        floor_plan_url: "/images/products/floor-plans/small-private-plans.png?crop_w=564%&crop_h=479%&crop_t=-236%&crop_l=-7%",
        display_order: 7,
        tagline: ""
    },
    {
        ...
        sub_category: "Private",
        size_category: "S",
        image_url: "/images/products/small/private/08-3x3-retreat.jpg",
...
따뜻한 차 한 잔을 우리거나 깊은 호흡을 내쉬는 순간. 이 낮은 공간은 당신을 가장 깊은 무의식의 휴식으로 안내할 것입니다.`,
        ...
        interior_finish: "자작나무",
        size: "3.2m X 3.2m X 높이 3.2m",
        floor_plan_url: "/images/products/floor-plans/small-private-plans.png?crop_w=657%&crop_h=479%&crop_t=-236%&crop_l=-137%",
        display_order: 8,
        tagline: ""
    },
    {
        ...
        sub_category: "Private",
        size_category: "S",
        image_url: "/images/products/small/private/09-3x6-manscave.jpg",
...
누구의 눈치도 볼 필요 없는 이 단단한 벙커 안에서, 잊고 있던 당신의 '소년'을 다시 깨우십시오.`,
        ...
        interior_finish: "자작나무,벽지,안타민",
        size: "3.2m X 6.2m X 높이 3.8m",
        floor_plan_url: "/images/products/floor-plans/small-private-plans.png?crop_w=420%&crop_h=479%&crop_t=-236%&crop_l=-147%",
        display_order: 9,
        tagline: ""
    },
    {
        ...
        sub_category: "Private",
        size_category: "S",
        image_url: "/images/products/small/private/10-3x6-peterpan.jpg",
...
이곳에서 아이들의 꿈은 피터팬의 그림자처럼 늘 함께 자라납니다.`,
        ...
        size: "3.2m X 6.2m X 높이 3.6m",
        floor_plan_url: "/images/products/floor-plans/small-private-plans.png?crop_w=427%&crop_h=479%&crop_t=-236%&crop_l=-251%",
        display_order: 10,
        tagline: ""
    },
    {
        ...
        sub_category: "Public",
        size_category: "S",
        image_url: "/images/products/small/public/11-3x6-busstop.jpg",
...
단순히 버스를 타는 곳이 아닙니다. 마을의 정이 머물고, 사람을 배려하는 따뜻한 쉼터입니다.`,
        ...
        floor_plan_url: "/images/products/floor-plans/small-public-plans.png?crop_w=407%&crop_h=628%&crop_t=-257%&crop_l=0%",
        display_order: 11,
        tagline: ""
    },
    {
        ...
        sub_category: "Public",
        size_category: "S",
        image_url: "/images/products/small/public/12-4x8-restroom.jpg",
...
설치하는 순간부터 관리자의 고민을 덜어주는 가장 스마트한 선택입니다.`,
        ...
        size: "3.2m X 6.2m X 높이 2.5m",
        floor_plan_url: "/images/products/floor-plans/small-public-plans.png?crop_w=353%&crop_h=454%&crop_t=-185%&crop_l=-115%",
        display_order: 12,
        tagline: ""
    },
    {
        ...
        sub_category: "Public",
        size_category: "S",
        image_url: "/images/products/small/public/13-3x9-pergola.jpg",
...
차가움과 따뜻함, 얇음과 견고함. 상반된 두 가치가 만나 완성한 구조적 미학의 정점을 경험해 보세요.`,
        ...
        floor_plan_url: "/images/products/floor-plans/small-public-plans.png?crop_w=367%&crop_h=621%&crop_t=-254%&crop_l=-257%",
        display_order: 13,
        tagline: ""
    }
];
