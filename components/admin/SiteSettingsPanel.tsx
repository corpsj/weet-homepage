...
export default function SiteSettingsPanel() {
  ...
  return (
    <ConsolePanel className="p-6">
      ...
      {loading ? (
        <div className="mt-6 flex items-center gap-2 text-sm text-admin-muted">
        ...
        <>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            {FIELD_ORDER.map((key) => (
              <div key={key}>
                <label htmlFor={`site-setting-${key}`} className="mb-1 block text-xs font-bold text-admin-muted">
